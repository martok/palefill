...
const _definitions = [
    ...
    },
    {
        ...
        fix: ["std-PerformanceObserver", "std-queueMicrotask", "gh-temp-oldindex2", "gh-integrity", "gh-compat", "sm-gh-extra", "sm-cookie"]
    },
    {
    ...
    {
        selector: ["github.githubassets.com/assets/8933-d8b0634d2391.js$script",
                   "github.githubassets.com/assets/2403-3e07b8533bbd.js$script",
                   "github.githubassets.com/assets/7253-67d624cbaf0c.js$script",
                   "github.githubassets.com/assets/7509-2ab465ae6095.js$script",
                   "github.githubassets.com/assets/5108-6f42d71a0f46.js$script"
                  ],
        fix: ["$script", "gh-script-optchain"]
    },
    {
        selector: ["gitlab.com"],
...
function evaluateFix(fix, script, csp, contentReplace) {
    switch(fix) {
        ...
        case "gl-script":
            ...
            contentReplace.push([String.raw`/^(?<indent>\s*)(?<leader>((?<isUl>[*+-])|(?<isOl>\d+\.))( \[([x ])\])?\s)(?<content>.)?/`, String.raw`/^(\s*)((([*+-])|(\d+\.))( \[([x ])\])?\s)(.)?/`]);
...
HTTPObserver.prototype.QueryInterface = XPCOMUtils.generateQI([Ci.nsIObserver, Ci.nsISupportsWeakReference]);
