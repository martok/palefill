            ...
            for (const selstr of defn.selector) {
                ...
                if (opts) {
                    for (const o of opts.substr(1).split(",")) {
                        if (o == "document") {
                            allowedTypes.add(Ci.nsIContentPolicy.TYPE_DOCUMENT);
                        } else if (o == "subdocument") {
                            allowedTypes.add(Ci.nsIContentPolicy.TYPE_SUBDOCUMENT);
                        } else if (o == "script") {
                            allowedTypes.add(Ci.nsIContentPolicy.TYPE_SCRIPT);
                        }
                    }
                }
