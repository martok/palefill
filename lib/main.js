...
const _definitions = [
    ...
    {
        selector: ["github.githubassets.com/assets/*.js$script"],
...
class PolyfillService {
    ...
    getFixes(URI, contentPolicy) {
        const aapplied = this.rules.getApplicable(URI, contentPolicy);
        if (!aapplied) {
            return null;
        }
