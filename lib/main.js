...
const _definitions = [
    {
        ...
        fix: ["$script-content", "stackexchange-optchain"]
    },
    {
    ...
    },
    {
        ...
        fix: ["$script-content", "dhl-optchain"]
    },
    {
    ...
    },
    {
        ...
        fix: ["$script-content", "reddit-comments-regexp"]
    },
    {
        selector: ["static.ce-cdn.net/vendor.v6.*.js$script"],
        fix: ["$script-content", "godbolt-script"]
    },
]
